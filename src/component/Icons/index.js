...
export const MessageIcon = ({ width = '2.2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const DeleteIcon = ({ width = '1.6rem', height = '1.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const SearchIcon = ({ width = '1.9rem', height = '1.9rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 48 48"
